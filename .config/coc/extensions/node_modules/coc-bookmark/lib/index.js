...
const bookmark_1 = __importDefault(__webpack_require__(5));
const commands_1 = __importDefault(__webpack_require__(34));
const path_1 = __importDefault(__webpack_require__(16));
const db_1 = __importDefault(__webpack_require__(35));
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = coc_nvim_1.workspace.getConfiguration('bookmark');
        const { subscriptions, storagePath } = context;
        const { nvim } = coc_nvim_1.workspace;
        const db = new db_1.default(path_1.default.join(storagePath, 'bookmark.json'));
        const bookmark = new commands_1.default(nvim, db);
        const stat = yield fs_1.statAsync(storagePath);
        if (!stat || !stat.isDirectory()) {
            yield fs_1.mkdirAsync(storagePath);
        }
        const sign = config.get('sign', '🔖');
        const signHl = config.get('signHl', 'Tag');
        ...
        subscriptions.push(coc_nvim_1.workspace.registerKeymap(['n'], 'bookmark-next', () => __awaiter(this, void 0, void 0, function* () { return yield bookmark.jumpTo('next'); }), { sync: false }));
        subscriptions.push(coc_nvim_1.workspace.registerKeymap(['n'], 'bookmark-prev', () => __awaiter(this, void 0, void 0, function* () { return yield bookmark.jumpTo('prev'); }), { sync: false }));
        ...
        subscriptions.push(coc_nvim_1.commands.registerCommand('bookmark.prev', () => __awaiter(this, void 0, void 0, function* () { return yield bookmark.jumpTo('prev'); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('bookmark.next', () => __awaiter(this, void 0, void 0, function* () { return yield bookmark.jumpTo('next'); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('bookmark.clearForCurrentFile', () => __awaiter(this, void 0, void 0, function* () { return yield bookmark.clear(false); })));
        subscriptions.push(coc_nvim_1.commands.registerCommand('bookmark.clearForAllFiles', () => __awaiter(this, void 0, void 0, function* () { return yield bookmark.clear(true); })));
...
class BookmarkList extends coc_nvim_1.BasicList {
    constructor(nvim, db) {
        ...
        this.db = db;
        this.name = 'bookmark';
        this.description = 'list of bookmarks';
        this.defaultAction = 'open';
        this.actions = [];
        this.addLocationActions();
        this.addAction('open', (item) => __awaiter(this, void 0, void 0, function* () {
            const { filepath, lnum } = item.data;
            const pos = vscode_languageserver_protocol_1.Position.create(lnum - 1, 0);
            yield coc_nvim_1.workspace.jumpTo(coc_nvim_1.Uri.file(filepath).toString(), pos);
        }));
        this.addAction('delete', (item) => __awaiter(this, void 0, void 0, function* () {
            const { filepath, lnum } = item.data;
            yield this.db.delete(`${commands_1.encode(filepath)}.${lnum}`);
    ...
    loadItems(_context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let [filepath, bookmarks] of Object.entries(data)) {
                filepath = commands_1.decode(filepath);
                const stat = yield fs_1.statAsync(filepath);
                if (!(stat && stat.isFile())) {
                    yield this.db.delete(`${commands_1.encode(filepath)}`);
                    continue;
                }
                for (const lnum of Object.keys(bookmarks).sort((l1, l2) => Number(l1) - Number(l2))) {
                    ...
                    items.push({
                        ...
                        location: {
                            uri: coc_nvim_1.Uri.file(filepath).toString(),
                            range: {
...
class Bookmark {
    ...
    getDocInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.lnum = (yield this.nvim.call('line', ['.']));
            this.line = yield this.nvim.line;
            this.filetype = doc.filetype;
            this.filepath = coc_nvim_1.Uri.parse(doc.uri).fsPath;
        });
    }
    create(annotate) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = { line: this.line, filetype: this.filetype };
            if (annotate)
                data.annotation = annotate;
            yield this.db.push(`${encode(this.filepath)}.${this.lnum}`, data);
        });
    }
    annotate() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    delete() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getDocInfo();
            yield this.db.delete(`${encode(this.filepath)}.${this.lnum}`);
            yield this.refresh();
            this.onChanged();
        });
    }
    toggle() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield this.db.exists(key)) {
                yield this.db.delete(key);
            }
            else {
                yield this.create();
            }
    ...
    jumpTo(direction) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getDocInfo();
            const bookmark = yield this.db.fetch(encode(this.filepath));
            if (bookmark) {
    ...
    refresh() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bufnr = (yield this.nvim.buffer).id;
            yield this.nvim.command(`silent! sign unplace * group=coc-bookmark buffer=${bufnr}`);
            // then add signs if exists
            yield this.getDocInfo();
            const bookmarks = yield this.db.fetch(`${encode(this.filepath)}`);
            if (bookmarks) {
    ...
    clear(all) {
        return __awaiter(this, void 0, void 0, function* () {
            if (all) {
                ...
                yield this.getDocInfo();
                yield this.db.push(`${encode(this.filepath)}`, {});
            }
            yield this.refresh();
            this.onChanged();
        });
...
class BookmarkDB {
    ...
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stat = yield fs_1.statAsync(dir);
            if (!stat || !stat.isDirectory()) {
                yield fs_1.mkdirAsync(dir);
                yield fs_1.writeFileAsync(this.filepath, '{}');
                return {};
            }
            try {
                const content = yield fs_1.readFileAsync(this.filepath);
                const data = JSON.parse(content.trim());
                // former bookmark data structure is an array.
                // so just clear them, sadly no other ways :(
                if (Array.isArray(data))
                    throw new Error("Outdated bookmark format");
                return data;
            }
            catch (_a) {
                yield fs_1.writeFileAsync(this.filepath, '{}');
    ...
    push(key, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < len; i++) {
                ...
                if (i == len - 1) {
                    obj[key] = data;
                    yield fs_1.writeFileAsync(this.filepath, JSON.stringify(origin, null, 2));
                    break;
                }
    ...
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
            let stat = yield fs_1.statAsync(this.filepath);
            if (!stat || !stat.isFile())
                return;
            yield fs_1.writeFileAsync(this.filepath, '{}');
        });
